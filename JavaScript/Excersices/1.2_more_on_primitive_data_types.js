...
//create a vari"able and after that assign a string with its value being: He's got it!
let myString = "He's got it!";
...
let tax = 1.12;
let totalBill = `Your total bill is ${restaurantBill * tax} $`;
